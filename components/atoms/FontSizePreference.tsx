...
export const FontSizeControl = () => {
  ...
  const fontSizes = [
    { value: "small" as const, label: "Small", size: "A" },
    { value: "medium" as const, label: "Medium", size: "A" },
    { value: "large" as const, label: "Large", size: "A" },
    { value: "extra-large" as const, label: "Extra Large", size: "A" },
  ];
